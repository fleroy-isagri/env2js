...
const SettingsFolderPathEnvKey string = "SETTINGS_FOLDER_PATH"
const SettingsFilePrefixEnvKey string = "SETTINGS_FILE_PREFIX"
const SettingsVariableNameEnvKey string = "SETTINGS_VARIABLE_NAME"
...
func DefineFilePath(settingsFolderPath string, settingsFilePrefix string) string {
...
func main() {
	...
	settingsFilePath := DefineFilePath(settingsFolderPath, settingsFilePrefix)
